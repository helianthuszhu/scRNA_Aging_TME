...
#setwd('/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org/output2_step2.5.3.filter_junk_scanpy_pipeline/data_Myeloidcell_v2')
#library(zellkonverter)
#mysce=readH5AD('adata_Myeloid_v2_degs_signature_louvain_recluster_renamed_signature.4s_added_subtype_Defined_bad_cluster_rm_generanked.h5ad')
#
...
datadir='output2_step2.5.3.filter_junk_scanpy_pipeline/data_Myeloidcell_v2/'
figdir='output2_step2.5.3.filter_junk_scanpy_pipeline/figure_Myeloidcell_v2/'
...
adata <- sc$read_h5ad(paste0(datadir, 'adata_Myeloid_v2_degs_signature_louvain_recluster_renamed_signature.4s_added_subtype_Defined_bad_cluster_rm_generanked.h5ad'))
adata
...
#
saveRDS(sce, file= paste0(datadir, 'adata_Myeloid_v2_degs_signature_louvain_recluster_renamed_signature.4s_added_subtype_Defined_bad_cluster_rm_generanked.rds'))
#############
######
...
######
library(Seurat)
sce= readRDS(paste0(datadir, 'adata_Myeloid_v2_degs_signature_louvain_recluster_renamed_signature.4s_added_subtype_Defined_bad_cluster_rm_generanked.rds'))
###
library(ggplot2)
library(ggpubr)
library(Polychrome)
...
pdf(paste0(figdir, '/boxplot_M1M2.ageGroup_vs_macs.pdf'),width=8,height = 5)
ggplot(statdata_mac)+
  aes(x = age_group, y = M1, fill = age_group) + # add color to boxes with fill
  ...
  stat_compare_means(aes(group = age_group),label.y = 2, label = "p.signif")+
...
ggplot(statdata_mac)+
  aes(x = age_group, y = M2, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
  #geom_jitter(alpha = 0.8, width = 0,size=1) + # adds random noise and limit its width
  facet_wrap(~Defined_Cell_Subtype_function, nrow=1) + # divide into 2 panels
  theme(legend.position = "none") +# remove legend
  scale_fill_manual(values =  age_color)+
  stat_compare_means(aes(group = age_group),label.y = 1.5, label = "p.signif")+
  stat_compare_means(comparisons = my_comparisons,label = "p.signif")+
  #ggtitle(paste0('Age','\n','No.',dim(clindata)[1]))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),legend.position="right",
        panel.border = element_blank(),
...
ggplot(statdata_mac)+
  aes(x = age_group, y = Angiogenesis, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
  #geom_jitter(alpha = 0.8, width = 0,size=1) + # adds random noise and limit its width
  facet_wrap(~Defined_Cell_Subtype_function, nrow=1) + # divide into 2 panels
...
ggplot(statdata_mac)+
  aes(x = age_group, y = Phagocytosis, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
  #geom_jitter(alpha = 0.8, width = 0,size=1) + # adds random noise and limit its width
  facet_wrap(~Defined_Cell_Subtype_function, nrow=1) + # divide into 2 panels
...
pdf(paste0(figdir, '/boxplot_M1M2.ageGroup_vs_macs_generally.pdf'),width=4,height = 5)
ggplot(statdata_mac)+
  aes(x = age_group, y = M1, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
...
sce= readRDS(paste0(datadir, 'adata_Myeloid_v2_degs_signature_louvain_recluster_renamed_signature.4s_added_subtype_Defined_bad_cluster_rm_generanked.rds'))
#
pathActi= read.csv('output3_step3.0.pathways_allcells/pathway_output.csv', header=T, row.names=1, sep='\t')
length(intersect(rownames(pathActi), rownames(sce@meta.data) ))
pathsel= pathActi[rownames(sce@meta.data), -c(1:31)]
statpath= cbind(sce@meta.data, pathsel)
dim(statpath)

statpath_mac= statpath[grep('Mac', statpath$Defined_Cell_Subtype_function), ]
#####
#####
library(ggplot2)
library(ggpubr)
...
pdf(paste0(figdir, '/boxplot_M1M2.ageGroup_vs_macs_signature_GSEA.pdf'),width=8,height = 5)
ggplot(statpath_mac)+
  ...
  theme(legend.position = "none") +# remove legend
  scale_fill_manual(values =  age_color)+
  stat_compare_means(aes(group = age_group),label.y = 1, label = "p.signif")+
  stat_compare_means(comparisons = my_comparisons,label = "p.signif")+
  #ggtitle(paste0('Age','\n','No.',dim(clindata)[1]))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),legend.position="right",
        panel.border = element_blank(),
...
ggplot(statpath_mac)+
  aes(x = age_group, y = KEGG_FC_GAMMA_R_MEDIATED_PHAGOCYTOSIS, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
  #geom_jitter(alpha = 0.8, width = 0,size=1) + # adds random noise and limit its width
  facet_wrap(~Defined_Cell_Subtype_function, nrow=1) + # divide into 2 panels
...
g2=ggplot(statpath_mac)+
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1),legend.position="right",
        ...
        panel.background = element_blank())
library(patchwork)
pdf(paste0(figdir, '/boxplot_M1M2.ageGroup_vs_macs_signature_GSEA_generally.pdf'),width=6,height = 5)
...
age_color= c('#F0E716','#47EFFA','#EE2EE8')
###
statdata= read.csv(paste0(datadir, 'adata_Myeloid_v2_degs_signature_louvain_recluster_renamed_signature.4s_added_subtype_Defined_bad_cluster_rm_generanked_DC_signatures_added.csv'))
statdata$Tcellsubtype= sapply(stringr::str_split(statdata$Defined_Cell_Subtype_function, "[-]"), `[`, 2)
table(statdata$Tcellsubtype)
statdata$age_group= factor(statdata$age_group,  levels= c('Young', 'Intermediated', 'Aged'))

#subset DCs
statdata_dc=statdata[grep('DC', statdata$Tcellsubtype),]


my_comparisons=list(c('Young', 'Aged'), c('Intermediated', 'Aged'), c('Young', 'Intermediated'))

pdf(paste0(figdir, '/boxplot_DCs.ageGroup_vs_DCs.pdf'),width=8,height = 5)
ggplot(statdata_dc)+
  aes(x = age_group, y = ActivatedDC, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
  #geom_jitter(alpha = 0.8, width = 0,size=1) + # adds random noise and limit its width
  facet_wrap(~Defined_Cell_Subtype_function, nrow=1) + # divide into 2 panels
...
ggplot(statdata_dc)+
  aes(x = age_group, y = MigratoryDC, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
  #geom_jitter(alpha = 0.8, width = 0,size=1) + # adds random noise and limit its width
  facet_wrap(~Defined_Cell_Subtype_function, nrow=1) + # divide into 2 panels
  theme(legend.position = "none") +# remove legend
  scale_fill_manual(values =  age_color)+
  stat_compare_means(aes(group = age_group),label.y = 0.6, label = "p.signif")+
  stat_compare_means(comparisons = my_comparisons,label = "p.signif")+
  #ggtitle(paste0('Age','\n','No.',dim(clindata)[1]))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),legend.position="right",
        panel.border = element_blank(),
...
pdf(paste0(figdir, '/boxplot_DCs.ageGroup_vs_DCs_genereally.pdf'),width=4,height = 5)
ggplot(statdata_dc)+
  aes(x = age_group, y = ActivatedDC, fill = age_group) + # add color to boxes with fill
  #geom_boxplot(varwidth = FALSE) + # vary boxes width according to n obs.
  geom_boxplot(aes(fill=age_group),outlier.colour = "black",outlier.size = 1)+
...
prostat_long$Defined_Cell_Subtype_function= factor(prostat_long$Defined_Cell_Subtype_function, 
     levels=c('C1-Monocyte-CD14','C2-Monocyte-CD16','C3-Mac-FABP4','C4-Mac-RETN','C5-Mac-MARCO',
...
tindex= c('C1-Monocyte-CD14','C2-Monocyte-CD16','C3-Mac-FABP4','C4-Mac-RETN','C5-Mac-MARCO',
              'C6-Mac-CCL13','C7-Mac-CX3CR1','C8-Mac-SPP1','C9-cDC1-CLEC9A','C10-cDC2-CLEC10A',
              'C11-cDCs-M-LAMP3','C12-pDC-LILRA4','C13-cDC-LCs-CD207','C14-Cycling-MKI67')
plist= list()
corlist= list()
...
write.csv(coda, paste0(figdir, '/DirichletReg_myeloid.coef.csv'))

pdf(paste0(figdir, '/DirichletReg_myeloid.pdf'),width=7,height = 9)
par(mar = c(4, 4, 4, 4) + 0.1)
plot(rep(ttd$Age, dim(AL)[2]), as.numeric(AL), pch = 21, bg = rep(mycol[1:dim(AL)[2]], each = dim(AL)[1]), xlab = "age (yr)", ylab = "Proportion",
       ylim = c(0, 1), main = "Myeloid Composition in Leader et al Lung Cancer by DirichletReg")
...
cell_type= c('C1-Monocyte-CD14'=color_CLASS[1],'C2-Monocyte-CD16'=color_CLASS[2],'C3-Mac-FABP4'=color_CLASS[3],
             'C4-Mac-RETN'=color_CLASS[4],'C5-Mac-MARCO'=color_CLASS[5],'C6-Mac-CCL13'=color_CLASS[6],
             'C7-Mac-CX3CR1'=color_CLASS[7],'C8-Mac-SPP1'=color_CLASS[8],'C9-cDC1-CLEC9A'=color_CLASS[9],
             'C10-cDC2-CLEC10A'=color_CLASS[10],'C11-cDCs-M-LAMP3'=color_CLASS[11],'C12-pDC-LILRA4'=color_CLASS[12],
             'C13-cDC-LCs-CD207'=color_CLASS[13],'C14-Cycling-MKI67'=color_CLASS[14])
             )
#
...
dlong$cell_type=factor(dlong$cell_type, levels=rev(c(
'C1-Monocyte-CD14','C2-Monocyte-CD16','C3-Mac-FABP4','C4-Mac-RETN','C5-Mac-MARCO','C6-Mac-CCL13','C7-Mac-CX3CR1','C8-Mac-SPP1','C9-cDC1-CLEC9A','C10-cDC2-CLEC10A','C11-cDCs-M-LAMP3','C12-pDC-LILRA4','C13-cDC-LCs-CD207','C14-Cycling-MKI67'
             )))
dlong 
...
sce
#
datadir='output2_step2.5.3.filter_junk_scanpy_pipeline/data_Myeloidcell_v2/aged_degs_smooth/'
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)
figdir='output2_step2.5.3.filter_junk_scanpy_pipeline/figure_Myeloidcell_v2/aged_degs_smooth/'
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)
#
######
#sce <- AddMetaData(
...
ggsave(paste0(figdir, '/degs_age_dependent_smooth_merged.pdf'),g,width =16,height = 20) 
####################################################
names(tfover)= cname2
...
################load data
#library(Seurat)
setwd('/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org/output4_step4.0.scenic.allcells.py/output_Myeloidcell')

figdir <- file.path("figure_Myeloidcell/")
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)

datadir <- file.path("data_Myeloidcell/")
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)

#####
#load seurat data to get cell type information
#
scdir='/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org/output2_step2.5.3.filter_junk_scanpy_pipeline/data_Myeloidcell_v2/'
library(Seurat)
...
cname= c( 'C1-Monocyte-CD14','C2-Monocyte-CD16','C3-Mac-FABP4','C4-Mac-RETN','C5-Mac-MARCO',
         'C6-Mac-CCL13','C7-Mac-CX3CR1','C8-Mac-SPP1','C9-cDC1-CLEC9A','C10-cDC2-CLEC10A',
         'C11-cDCs-M-LAMP3','c12-pDC-LILRA4','C13-cDC-LCs-CD207','C14-Cycling-MKI67')
#
source('/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org/useful_R_Fun.pheatmap.add.flag.R')
...
figdir <- file.path("figure_Myeloidcell/reduced/")
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)

datadir <- file.path("data_Myeloidcell/reduced/")
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)


cname2= c( 'C1-Monocyte-CD14','C2-Monocyte-CD16','C3-Mac-FABP4','C4-Mac-RETN','C5-Mac-MARCO',
         'C6-Mac-CCL13','C7-Mac-CX3CR1','C8-Mac-SPP1','C9-cDC1-CLEC9A','C10-cDC2-CLEC10A',
         'C11-cDCs-M-LAMP3','c12-pDC-LILRA4','C13-cDC-LCs-CD207','C14-Cycling-MKI67')
#
gage= read.csv('/data/Zhuxq/young_LC_analysis/gseaDB/genage_human.csv', header=T)
...
down_cluster=c(3)
i=1
    load(paste0('data_Myeloidcell/',cname2[i],'_data_for_subheatmap_draw.RData'))
    gsel= rownames(subset(annotation_row, Cluster %in% c(up_cluster,down_cluster )))
    lenupg= length(rownames(subset(annotation_row, Cluster %in% up_cluster )))
    lendowng= length(rownames(subset(annotation_row, Cluster %in% down_cluster )))   
...
head(enrich_merged)
enrich_merged$celltype= factor(enrich_merged$celltype, levels=c('C1-Monocyte-CD14','C2-Monocyte-CD16','C3-Mac-FABP4','C4-Mac-RETN','C5-Mac-MARCO','C6-Mac-CCL13','C7-Mac-CX3CR1','C8-Mac-SPP1','C9-cDC1-CLEC9A','C10-cDC2-CLEC10A','C11-cDCs-M-LAMP3','C12-pDC-LILRA4','C13-cDC-LCs-CD207','C14-Cycling-MKI67'))
...
write.csv(gene_list_merged, file= paste0(datadir,'myeloid_age_dependent_DEGs_list_merged.csv'))
#####
