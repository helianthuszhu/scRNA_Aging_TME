...
setwd('/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org/output2_step2.5.3.filter_junk_scanpy_pipeline/data_Bcell_v2')
library(zellkonverter)
mysce=readH5AD('adata_Bcell_v2_degs_subtype_Defined_aged_clustered.h5ad')
#
library(Seurat)
sce=  as.Seurat(mysce, counts = "counts", data = "logcounts")

saveRDS(sce, file= 'adata_Bcell_v2_degs_subtype_Defined_aged_clustered.zellkonverter.rds')
...
datadir='output2_step2.5.3.filter_junk_scanpy_pipeline/data_Bcell_v2/'
figdir='output2_step2.5.3.filter_junk_scanpy_pipeline/figure_Bcell_v2/'
...
adata <- sc$read_h5ad(paste0(datadir, 'adata_Bcell_v2_degs_subtype_Defined_aged_clustered.h5ad'))
adata
...
#
saveRDS(sce, file= paste0(datadir, 'adata_Bcell_v2_degs_subtype_Defined_aged_clustered.rds'))
#############
######
...
#head(meta)
library(Seurat)
sce= readRDS(paste0(datadir, 'adata_Bcell_v2_degs_subtype_Defined_aged_clustered.rds'))
sce
...
prostat_long$Defined_Cell_Subtype_function= factor(prostat_long$Defined_Cell_Subtype_function, 
     levels=c('C1-Bcell-GPR183','C2-Bcell-HSPA8','C3-Bcell-IGHD','C4-Bcell-RGS13','C5-Bcell-STMN1',
              'C6-Bcell-IGHA1-PRMD1-pos','C7-Bcell-IGHA1-PRMD1-neg'))
...
tindex= c('C1-Bcell-GPR183','C2-Bcell-HSPA8','C3-Bcell-IGHD','C4-Bcell-RGS13','C5-Bcell-STMN1',
              'C6-Bcell-IGHA1-PRMD1-pos','C7-Bcell-IGHA1-PRMD1-neg')
plist= list()
corlist= list()
...
ggplot(tcellcor, aes(x = cor, y = name,color=Pvalue)) +
    ...
    scale_x_continuous(breaks=seq(-0.7, 0.9, 0.3), limits = c(-0.7, 0.9))
dev.off()
...
setwd('/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org')
datadir='output2_step2.5.3.filter_junk_scanpy_pipeline/data_Bcell_v2/aged_degs_seurat/'
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)
figdir='output2_step2.5.3.filter_junk_scanpy_pipeline/figure_Bcell_v2/aged_degs_seurat/'
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)
#######
library(Seurat)
sce = readRDS(paste0('output2_step2.5.3.filter_junk_scanpy_pipeline/data_Bcell_v2/', 'adata_Bcell_v2_degs_subtype_Defined_aged_clustered.rds'))
sce
#######
#sce <- AddMetaData(
 # object = sce,
...
cell_type= c('C1-Bcell-GPR183'=color_CLASS[1],'C2-Bcell-HSPA8'=color_CLASS[2],'C3-Bcell-IGHD'=color_CLASS[3],
            'C4-Bcell-RGS13'=color_CLASS[4],'C5-Bcell-STMN1'=color_CLASS[5], 'C6-Bcell-IGHA1-PRMD1-pos'=color_CLASS[6], 'C7-Bcell-IGHA1-PRMD1-neg'= color_CLASS[7] )
             )
...
dlong$cell_type=factor(dlong$cell_type, levels=rev(c('C1-Bcell-GPR183','C2-Bcell-HSPA8',
                                                     'C3-Bcell-IGHD','C4-Bcell-RGS13','C5-Bcell-STMN1',
              'C6-Bcell-IGHA1-PRMD1-pos','C7-Bcell-IGHA1-PRMD1-neg'
             )))
dlong 
...
sce
#
datadir='output2_step2.5.3.filter_junk_scanpy_pipeline/data_Bcell_v2/aged_degs_smooth/'
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)
figdir='output2_step2.5.3.filter_junk_scanpy_pipeline/figure_Bcell_v2/aged_degs_smooth/'
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)
#
######
#sce <- AddMetaData(
...
cname2=c('C1-Bcell-GPR183','C2-Bcell-HSPA8','C3-Bcell-IGHD','C4-Bcell-RGS13','C5-Bcell-STMN1',
              'C6-Bcell-IGHA1-PRMD1-pos','C7-Bcell-IGHA1-PRMD1-neg'
             )
##################
plot_list=list()
...
ggsave(paste0(figdir, '/degs_age_dependent_smooth_merged.pdf'),g,width =15,height = 8) 
####################################################
names(tfover)= cname2
...
################load data
#library(Seurat)
setwd('/data/Zhuxq/young_LC_analysis/my_analysis4_merge.Pubdata.org/output4_step4.0.scenic.allcells.py/output_Bcell')

figdir <- file.path("figure_Bcell/")
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)

datadir <- file.path("data_Bcell/")
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)
...
cname=c('C1-Bcell-GPR183','C2-Bcell-HSPA8','C3-Bcell-IGHD','C4-Bcell-RGS13','C5-Bcell-STMN1',
              'C6-Bcell-IGHA1-PRMD1-pos','C7-Bcell-IGHA1-PRMD1-neg'
             )
...
figdir <- file.path("figure_Bcell/reduced/")
if(!dir.exists(figdir)) dir.create(figdir,recursive=TRUE)

datadir <- file.path("data_Bcell/reduced/")
if(!dir.exists(datadir)) dir.create(datadir,recursive=TRUE)
...
down_cluster=c(4,6)
i=1
    load(paste0('data_Bcell/',cname2[i],'_data_for_subheatmap_draw.RData'))
    gsel= rownames(subset(annotation_row, Cluster %in% c(up_cluster,down_cluster )))
    lenupg= length(rownames(subset(annotation_row, Cluster %in% up_cluster )))
    lendowng= length(rownames(subset(annotation_row, Cluster %in% down_cluster )))   
...
'C1-Bcell-GPR183','C2-Bcell-HSPA8','C3-Bcell-IGHD','C4-Bcell-RGS13','C5-Bcell-STMN1','C6-Bcell-IGHA1-PRMD1-pos','C7-Bcell-IGHA1-PRMD1-neg'))
...
write.csv(gene_list_merged, file= paste0(datadir,'Bcell_age_dependent_DEGs_list_merged.csv'))
#####
